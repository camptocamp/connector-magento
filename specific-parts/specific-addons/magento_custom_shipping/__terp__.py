...
##############################################################################
{
    ...
    'version' : '1',
    'depends' : ['base', 'stock', 'delivery', 'sale', 'base_sale_multichannels', 'magentoerpconnect', 'c2c_pack_product_chg'],
    'author' : 'Camptocamp',
    'description': """Customisation of the Magento ERP Connector module to handle packings modifications on Magento.
