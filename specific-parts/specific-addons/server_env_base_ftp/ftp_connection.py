...
class FtpConnection(osv.osv):
    ...
    _columns = {
        ...
        'is_tsl': fields.function(_get_config, type='boolean',
                    method=True, string='TSL?', multi='config'),
        'is_ssh': fields.function(_get_config, type='boolean',
                    method=True, string='SFTP?', multi='config'),
